...
import os
import joblib
from model_loader import load_model  # Import the new model loader function
...
# Modeling
    ...
    if st.button("Identifying the Optimal Model: Comparative Analysis and Rationale"):
        ...
        st.write("""
        Random Forests often emerge as the best model due to their balance between accuracy and robustness. Here's a summary of why Random Forest might be the best model in this context:

        - <span style="color:red;">**Linear Regression**</span>: Shows similar performance on both training and test sets, indicating no overfitting.
        - <span style="color:red;">**Decision Tree Regressor**</span>: Exhibits perfect R² on the training set but much worse on the test set, indicating overfitting.
        - <span style="color:red;">**Random Forest Regressor**</span>: Displays high performance on both sets with a slight drop on the test set, suggesting mild overfitting, but remains robust due to averaging multiple trees.
        - <span style="color:red;">**Ridge Regression**</span>: Performs similarly on both sets, indicating no overfitting.
        - <span style="color:red;">**Gradient Boosting Regressor**</span>: Shows good performance on both sets with slight overfitting.
        - <span style="color:red;">**Lasso**</span>: Underfits, performing poorly on both training and test sets.
        - <span style="color:red;">**LassoCV**</span>: Like Ridge, performs similarly on both sets, indicating no overfitting.
        - <span style="color:red;">**ElasticNet**</span>: Performs similarly on both sets, indicating no overfitting.
        ...
        st.write("""<span style="color:red;">**Conclusion**</span>: Random Forest is the best model based on comparison plots, showing high accuracy and consistent R² and MSE scores between training and test sets, indicating robustness against overfitting. It outperforms the Decision Tree Regressor, which struggles with discrepancies in performance. Random Forest handles various data types well and is easy to use, providing reliable and accurate predictions, making it the optimal model for this application.
        """, unsafe_allow_html=True)

    # Button Random Forest Regressor
    if st.button("Random Forest Regressor"):
        st.write("Random Forest is an ensemble method for classification and regression. It builds multiple decision trees on random data subsets, improving accuracy and reducing overfitting. Predictions are made by averaging (regression) or majority vote (classification). This method is valued for its accuracy and ease of use.")
...
# Button Overfitting Analysis in Model Training
    ...
    if st.button("Strategies to Prevent Overfitting"):
        ...
        <span style="color:red;">**Pruning (for Decision Trees):**</span>  
        ...
        <span style="color:red;">**Dropout (for Neural Networks):**</span>  
